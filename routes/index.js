...
router.get('/', function (req, res) {
  res.render('index', { title: 'Aquarium App', user: req.user });
});
router.get('/register', function (req, res) {
  res.render('register', { title: 'Aquarium App Registration' });
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Aquarium App Login', user : req.user });
 });
